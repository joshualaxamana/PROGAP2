 <footer class="footer">
        <div class="container">
            ...
            <div class="copyright pull-right">
                &copy; 2017, made with <i class="material-icons">favorite</i> by Aim for 4.0 for a better PROGAP grade.
 ...
 <!-- Login Modal -->
    ...
    <div class="modal fade spacer" id="myModal" tabindex="-1" role="dialog"
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-4">
            <br />
            <br />
            <div class="card card-signup spacer">
                <form class="form" method="" action="">
                    ...
                    <div class="footer text-center">
                        <button class="btn btn-simple btn-success btn-lg">Login</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-4">
            ...
            <div class="card card-signup spacer">
                <form class="form" method="" action="">
                    ...
                    <div class="footer text-center">
                        <button class="btn btn-simple btn-success btn-lg">Signup</button>
                    </div>
                </form>
            </div>
        </div>
      ...
      <div class="modal-body">
       ...
       <div class="col-lg-6">
          ...
          <div class="col-lg-6">
              ...
              <h6>An adaptation of the fairy tale about a monstrous-looking prince and a young woman who fall in love.</h6>
          </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-yellow btn-simple">Book Ticket</button>
      </div>
            </div>
    </div>
  </div>
